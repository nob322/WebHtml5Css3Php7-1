...
<head>
    ...
    <body>
        ...
        <section class="servicios">
           <h2 class="fontBlanco mtYmbTitles"><i class="fa-solid fa-circle-plus"></i> NOVEDADES</h2>
       <div class="contenedorArticles">
          <article class="cajaNovedades">
            <h4 class="fontBlanco centrarTextoHorizontal"><i class="fa-solid fa-child"></i> Operaciones Laser</h4> 
            <img src="img/nov1.jpg" alt="Mascota en pleno baño" style="heght:auto;width:100%;">
            <p class="fontBlanco" style="text-align:center;"><i class="fa-solid fa-calendar-days"></i><i> 5/2/22</i></p>
             <p class="fontBlanco" style="padding-left:5px;padding-right:5px;">Ahora hemos adquirido un bisturí de nueva generación,dando
              cómo resultado operaciones más seguras y acortamos el tiempo
              del proceso quirurgico.</p>
          </article>
          <article class="cajaNovedades">
              <h4 class="fontBlanco centrarTextoHorizontal"><i class="fa-solid fa-child"></i> 10% descuento</h4>
              <img src="img/nov3.jpg" alt="Cara feliz" style="heght:auto;width:100%;"> 
              <p class="fontBlanco" style="text-align:center;"><i class="fa-solid fa-calendar-days"></i><i> 9/3/22</i></p>
              <p class="fontBlanco" style="padding-left:5px;padding-right:5px;">Frente a los asaltos permanentes por parte de la corporación política a los ciudadanos con los impuestos más altos del mundo, hemos decidido aplicar <b>permanentemente un descuento</b> para nuestros clientes del 10%.</p>
             
          </article>
          <article class="cajaNovedades">
              <h4 class="fontBlanco centrarTextoHorizontal"><i class="fa-solid fa-child"></i> Paseamos perros</h4> 
          <img src="img/nov2.jpg" alt="Perro recibiendo una pipeta" style="heght:auto;width:100%;">
            <p class="fontBlanco" style="text-align:center;"><i class="fa-solid fa-calendar-days"></i><i> 20/3/22</i></p>
             <p class="fontBlanco" style="padding-left:5px;padding-right:5px;">Hemos conformado  5 equipos profesionales de paseadores y ahora sumamos un nuevo servicio para ofrecerle,retiramos y entregamos a domicilio.</p>
          </article>
