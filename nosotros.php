...
<head>
    ...
    <body>
        ...
        <section class="nosotros">
           <h2 class="fontBlanco mtYmbTitles"><i class="fa-solid fa-hat-cowboy"></i> NOSOTROS</h2>
       <div class="cajaNosotros" style="margin-top:-24px;">
        <p class="fontBlanco">
            En Veterinaria Ros compartimos como usted esa pasión y cariño por las mascotas, por lo que nos esmeramos en brindar un servicio profesional de excelencia, basados en la calidad y calidez de atención.</p>
         <P class="fontBlanco" >
             Somos pioneros en el mercado local en servicios de veterinaría. Veterinaria Ros fue la primera firma local que surgió, en 1932 desde Rosario, producto de una megafusión de empresas de veterinarias profesionales de Uk y Rusia. Desde entonces nos establecimos en Argentina con el compromiso de brindar servicios construyendo una relación directa con los clientes desde la confianza y el compromiso.
             Contamos con un equipo multidisciplinario, integrado por más de 200 colaboradores que prestan servicios a más de 5.100 particulares desde nuestros locales ubicados en barrio Fisherton, 7 de Septiembre y centro.  
           </P>
         <div class="cajaNosotros">
             <p class="fontBlanco">Trabajamos junto con grandes, medianas y pequeñas empresas, particulares he instituciones sin fines de lucro y organismos del sector público para ayudarlas a mejorar y preservar la salud de sus animales y mascotas.
             Contamos con un enfoque que vincula cada problema con nuestra oferta de servicios, que junto a la especialización por  de nuestros profesionales, nos permite brindar un asesoramiento a medida con una visión integral.
             Hoy Veterinaria Ros es una red local que opera en 3 barrios con más de 200 profesionales de distintas disciplinas.</p>
<!--             <img src="img/Nosotros-2.jpg" alt="Nosotros" class="imgResponsive" style="height:auto;width:40%!important;">-->
         </div>
